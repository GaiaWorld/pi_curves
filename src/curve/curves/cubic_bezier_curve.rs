use crate::{curve::{frame_curve::FrameCurve, frame::{FrameDataValue, KeyFrameCurveValue}}, bezier};


pub fn interplate_cubebezier<T: FrameDataValue>(curve: &FrameCurve<T>, target_frame: f32) -> T {
